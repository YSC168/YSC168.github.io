...
var client;var selected;document.getElementById("i").style.background="url('"+profile+"') no-repeat center/cover";var scale=window.devicePixelRatio;document.getElementById("titleinfo").innerHTML="YSC最帅";if(navigator.userAgent.match(/Alipay/i)){console.log("ALIPAY CLIENT");window.location.href=alipay;var title="";var subtitle="";removal()}
